...
function PersonalityRecommendationChart({combined}) {
  const benchmark = useBenchmark();
  const disabled = useDisabledComponent("PersonalityRecommendationChart");
  ...
  useComponentEvents("PersonalityRecommendationChart");
...
PersonalityRecommendationChart.defaultProps = {combined: false};
PersonalityRecommendationChart.propTypes = {combined: PropTypes.bool};

export default PersonalityRecommendationChart;
