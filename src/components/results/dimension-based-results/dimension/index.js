        ...
        <div class={style.main} style={`background: ${this.convertHex(color,8.5)};`}>
          ...
          <div class={style.content}>
            ...
            <p class={style.description}>{type.description}</p>
						<p class={style.center}><a class={style.trigger} style={`background: ${this.convertHex(color,30)}`} onClick={this.trigger.bind(null, this)} href="#">{this.props.translate(this.state.showContent ? "show_less" : "show_more")}</a></p>
          </div>
        </div>
