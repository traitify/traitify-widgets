import {Component} from "components/results/financial-risk-results/personality-takeaways";
...
describe("PersonalityTakeaways", () => {
  ...
  describe("callbacks", () => {
    it("triggers initialization", () => {
      ...
      expect(props.ui.trigger).toHaveBeenCalledWith("PersonalityTakeaways.initialized", component.instance);
    });
    ...
    it("triggers update", () => {
      ...
      expect(props.ui.trigger).toHaveBeenCalledWith("PersonalityTakeaways.updated", component.instance);
    });
  });
  ...
  it("renders nothing if no takeaways", () => {
    props.assessment = {
      ...props.assessment,
      archetype: {...props.assessment.archetype, details: []}
    };
    const component = new ComponentHandler(<Component {...props} />);
