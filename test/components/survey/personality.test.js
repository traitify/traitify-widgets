...
import * as helpers from "components/survey/personality/helpers";

jest.mock("components/survey/personality/not-ready", () => (() => (<div className="mock">NotReady</div>)));
jest.mock("components/survey/personality/slide", () => (() => (<div className="mock">Slide</div>)));
